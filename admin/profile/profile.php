                                    ...
                                    <div class="profile-pic text-center mb-5">
                                        ...
                                        <div>
                                            <div class="relative h-24 w-24 mx-auto">
                                                <img src="assets/images/client/05.jpg" class="rounded-full shadow dark:shadow-gray-700 ring-4 ring-slate-50 dark:ring-slate-800" id="profile-image" alt="">
                                    ...
                                    <div class="border-t border-gray-100 dark:border-gray-700">
                                        <ul class="list-none sidebar-nav mb-0 mt-3" id="navmenu-nav">
                                            <li class="navbar-item account-menu">
                                                <a href="profile.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <li class="navbar-item account-menu">
                                                <a href="profile-billing.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <li class="navbar-item account-menu">
                                                <a href="profile-payment.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <li class="navbar-item account-menu">
                                                <a href="profile-social.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <li class="navbar-item account-menu">
                                                <a href="profile-notification.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <li class="navbar-item account-menu">
                                                <a href="profile-setting.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <li class="navbar-item account-menu">
                                                <a href="auth-lock-screen.php" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                            ...
                                            <div class="group relative block overflow-hidden rounded-md duration-500">
                                                ...
                                                <div class="content duration-500">
                                                    ...
                                                    <div class="absolute z-10 opacity-0 group-hover:opacity-100 bottom-6 start-6 duration-500">
                                                        <a href="portfolio-detail-three.php" class="h6 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Mockup Collection</a>
